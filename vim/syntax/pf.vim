...
"   syn region	pfFold1		start=/^#\{1}>/ end=/^#\{1,3}>/me=s-1 transparent
"   fold
"   syn region	pfFold2		start=/^#\{2}>/ end=/^#\{2,3}>/me=s-1 transparent
"   fold
"   syn region	pfFold3		start=/^#\{3}>/ end=/^#\{3}>/me=s-1 transparent
"   fold
"   syn region	pfList		start=/{/ end=/}/ transparent
"   contains=ALLBUT,pfErrClose,@pfNotLS
"   syn region	pfString	start=/"/ skip=/\\"/ end=/"/
"   contains=pfIPv4,pfIPv6,pfNetmask,pfTable,pfVar
"   syn region	pfString	start=/'/ skip=/\\'/ end=/'/
"   contains=pfIPv4,pfIPv6,pfNetmask,pfTable,pfVar
"
